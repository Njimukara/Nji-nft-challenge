...
const Home = ({collections}: Props) => {
  ...
  return (
    <div className="mx-auto max-w-7xl py-20 px-10 2xl:px-0 flex min-h-screen flex-col items-center justify-center">
      <Head>
      ...
      <main className="bg-slate-100 p-10 shadow-xl shadow-blue-200">
