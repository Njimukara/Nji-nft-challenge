        ...
        <div className="bg-gradient-to-br from-cyan-400 to-rose-500 lg:col-span-4">
            <div className="flex flex-col items-center justify-center py-2 lg:min-h-screen">
                <div className="bg-gradient-to-br from-yellow-400 to-purple-700 p-2 rounded-xl">
                    ...
                    src="/images/erec.png" alt="nft-login" />
                </div>
        ...
        <div className="flex flex-1 flex-col p-12 lg:col-span-6">
            ...
            <div className="pt-10 flex flex-1 flex-col items-center text-center lg:space-y-0 lg:justify-center">
                <p className="text-2xl">
                    Discover the <span className="text--3xl font-bold">largest NFT Marketplace</span> challenge with <span className="text--3xl font-bold">PapaReact</span>
                </p>
                ...
                {/* <img className="w-80 object-cover pb-10 lg:h-40" src="https://links.papareact.com/bdy" alt="apes-nft" />

                <h1 className="text-3xl font-bold lg:text-5xl lg:font-extrabold">The PapaFam Age coding club. NfT drop</h1>
